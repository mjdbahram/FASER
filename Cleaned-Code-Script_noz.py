...
def save2txt(mV, generic_file_name, data, out_put_dir = './noz'):
    ...
    file_path = os.path.join(out_put_dir, "mV=%e"%mV + "_" + generic_file_name + '.txt')
...
save2txt(mV, 'NOE_SM_nu_e', NOE_SM_nu_e, out_put_dir = './noz')
...
save2txt(mV, 'NOE_SM_anu_e', NOE_SM_anu_e, out_put_dir = './noz')
...
save2txt(mV, 'NOE_SM_nu_tau', NOE_SM_nu_tau, out_put_dir = './noz')
...
save2txt(mV, 'NOE_SM_anu_tau', NOE_SM_anu_tau, out_put_dir = './noz')
...
for mV in mVs:
    ...
    save2txt(mV, 'NOE_BSM_nu_e_mu_gee', NOE_BSM_nu_e_mu_gee, out_put_dir = './noz')
    ...
    save2txt(mV, 'NOE_BSM_anu_e_mu_gee', NOE_BSM_anu_e_mu_gee, out_put_dir = './noz')
    ...
    save2txt(mV, 'NOE_BSM_nu_e_mu_get', NOE_BSM_nu_e_mu_get, out_put_dir = './noz')
    ...
    save2txt(mV, 'NOE_BSM_anu_e_mu_get', NOE_BSM_anu_e_mu_get, out_put_dir = './noz')
    ...
    save2txt(mV, 'NOE_BSM_nu_tau_mu_get', NOE_BSM_nu_tau_mu_get, out_put_dir = './noz')
    ...
    save2txt(mV, 'NOE_BSM_anu_tau_mu_get', NOE_BSM_anu_tau_mu_get, out_put_dir = './noz')
